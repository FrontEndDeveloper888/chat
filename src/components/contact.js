...
import {
    Box, List, ListItem, ListItemText, TextField, Button, Avatar, Modal, InputAdornment, InputLabel, Typography
} from "@mui/material";
...
const Contacts = ({contacts, onContactSelect, selectedContact, onAddContact}) => {
    ...
    return (<Box sx={{width: "20%"}}>
        ...
        <Box sx={{maxHeight: "calc(100vh - 150px)", overflowY: "auto",
            ...
            {filteredContacts.length > 0 ? (<List>
            ...
            </List>) : searched ? (<Typography variant="h6"
                                               sx={{
                                                   textAlign: "center",
                                                   marginTop: "5%",
                                                   marginBottom: "20px",
